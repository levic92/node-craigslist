...
var debug = (0, _debug2.default)('craigslist'),
    ...
    QUERY_KEYS = ['category', 'maxAsk', 'minAsk', 'query', 'searchType'],
...
function _getRequestOptions(options, query) {
	...
	if (!_core2.default.Validation.isEmpty(options.searchType)) {
		requestOptions.path = [requestOptions.path, QUERY_PARAM_SEARCH_TYPE, options.searchType].join('');
	}
